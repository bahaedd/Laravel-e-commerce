    ...
    export default {
        ...
        methods: {
            loadProductAttributes(id) {
                let _this = this;
                axios.post('/products/attributes', {
                    id: id
            ...
            loadAttributes() {
                let _this = this;
                axios.get('/products/attributes/load').then (function(response){
            ...
            selectAttribute(attribute) {
                ...
                axios.post('/products/attributes/values', {
                    id: attribute.id
                }).then (function(response){
            ...
            addProductAttribute() {
                if (this.currentQty === null || this.currentPrice === null) {
                    ...
                    axios.post('/products/attributes/add', {
                        data: data
                    }).then (function(response){
            ...
            deleteProductAttribute(pa) {
                ...
                this.$swal({
                    ...
                    if (willDelete) {
                        console.log(pa.id);
                        axios.post('/products/attributes/delete', {
                            id: pa.id,
                        }).then (function(response){
                            if (response.data.status === 'success') {
                                _this.productAttributes.splice(_this.attribute_id);
